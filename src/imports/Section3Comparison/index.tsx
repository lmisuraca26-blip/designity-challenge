import svgPaths from "./svg-ckqr3rphut";
type IconsProps = {
  className?: string;
  colour?: "White";
  kind?: "Check" | "x";
...
export default function Section3Comparison() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#f9f9fb] from-[51.913%] gap-[64px] items-center justify-center px-[60px] py-[80px] relative size-full to-[51.923%] to-white" data-name="Section 3: Comparison">
      <div className="absolute flex h-[2204.734px] items-center justify-center left-[-437.48px] top-[-586.89px] w-[2341.625px]">
